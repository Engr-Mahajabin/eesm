                    ...
                    {stats.map((item, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                /* এখানে border-slate-200 এবং dark:border-slate-800 যোগ করা হয়েছে */
                                className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white p-8 transition shadow-sm dark:bg-slate-900 dark:shadow-none"
                            >
